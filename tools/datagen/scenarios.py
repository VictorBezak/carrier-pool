...
def build_load_specs() -> list[LoadSpec]:
    ...
    specs.extend(
        [
            ...
            _load("bo-day11-cold", Broker.BROKEROS, "c_med", None, "conroe", "selma", Equipment.REEFER, 1280, None, 40, lifecycle="day11", scenario_ids=("cold_lane",)),
...
SCENARIOS: dict[str, Scenario] = {
    ...
    "cold_lane": Scenario("cold_lane", "Cold lane", "BrokerOS has no Conroe to Selma history.", "The price estimate should fall back geographically and show low confidence."),
